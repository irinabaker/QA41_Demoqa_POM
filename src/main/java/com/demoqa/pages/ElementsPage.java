...
public class ElementsPage extends BasePage {
    ...
    public ElementsPage preformMouseEvent() {
        pause(1000);
        moveWithJS(uploadFile, 0, 200);
        clickWithRectangle(uploadFile, 10, 3);
    ...
    public ElementsPage clickOnSubmitButtonWitJS() {
    ...
    public ElementsPage checkBrokenImages() {
        ...
        //check the received links
        for (int i = 0; i < images.size(); i++) {
            WebElement image = images.get(i);
            String imageUrl = image.getAttribute("src");
            verifyLinks(imageUrl);

            //check images display with JS executor
            try {
    ...
    public ElementsPage keyBoardEvent(String address) {
        ...
        //press TAB Kye to switch to permanent address
